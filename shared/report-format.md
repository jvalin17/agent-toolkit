...
Every file generated by agent-toolkit skills MUST include this HTML comment as the **first line**:

```
<!-- agent-toolkit:<skill-name> | v1 | <date> | <report-id> -->
```

Examples:
```
<!-- agent-toolkit:requirements | v1 | 2026-04-24 | a1b2c3d4 -->
<!-- agent-toolkit:architecture | v1 | 2026-04-24 | e5f6g7h8 -->
<!-- agent-toolkit:implementation | v1 | 2026-04-24 | i9j0k1l2 -->
```

This applies to ALL output files: requirements docs, architecture docs, reports, scorecards.

**Why:** Identifies files produced by this toolkit vs manually written files.
**How evaluate uses it:** If the tag is found, evaluate knows which skill produced the file and can cross-reference the report. If the tag is NOT found, evaluate treats it as an external file and works normally.
